...
class Model(nn.Module):
    ...
    def setup_caches(self, max_batch_size: int) -> torch.Tensor:
        ...
        with device:
            ...
            self.decoder.setup_caches(
                max_batch_size, dtype, decoder_max_seq_len=self.args.audio_num_codebooks
            )
        ...
        self.register_buffer(
            "decoder_causal_mask",
            _create_causal_mask(self.args.audio_num_codebooks, device),
        )
    ...
    def _embed_tokens(self, tokens: torch.Tensor) -> torch.Tensor:
        ...
        audio_tokens = tokens[:, :, :-1] + (
            ...
            * torch.arange(self.args.audio_num_codebooks, device=tokens.device)
        )
